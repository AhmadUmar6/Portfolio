  ...
  return (
    <div className="eclat-container">
      ...
      <div className="content-section">
        ...
        <p>
          ÉCLAT is an e-commerce platform designed and devloped for an online jewellery store based in the UK, developed as a freelance project. The vision was to create a luxurious and intuitive digital boutique that beautifully showcases exquisite jewellery collections and provides a seamless shopping experience for discerning customers.
        </p>
